...
function Itinerary({ itineraryOptions }) {
  ...
  return (
    <div>
      ...
      {Object.keys(itineraryOptions || {}).map((day, index) => (
        <div
          key={day}
        ...
        >
          ...
          <p className="text-sm text-gray-500 sm:mt-4"></p>
          {itineraryOptions[day].plan.map((place, index) => (
            <div
              key={index}
